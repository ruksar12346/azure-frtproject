...
<script src="SpeechSDK/microsoft.cognitiveservices.speech.sdk.bundle.js"></script>
 <script src="azureTextToSpeech.js"></script>
<?php
 $cid=$_GET['vid'];
...
<div  id="exampl">
      ...
      <table border="1" class="table table-bordered mg-b-0">
        <tr>
          <th colspan="4" style="text-align: center; font-size:22px;"> Vehicle Parking Speech</th>

        </tr>
   
   <tr>
                               <!-- <th>Parking Number</th> -->
                                   <td id="inputText">Parking Number is <?php  echo $row['ParkingNumber'];?></td>
...
<div>
<button onclick="startTextToSpeech()">Click to Listen</button>
